...
if(REXSDK_DIR)
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.7.8.2 QUIET CONFIG)
    endif()
...
# Codegen target - run 'cmake --build . --target midnightclub_codegen'
add_custom_target(midnightclub_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/midnightclub_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for midnightclub"
    VERBATIM
)
